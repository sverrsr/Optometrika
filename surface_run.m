...
screen_offset = max(20, lens_depth + 0.75 * clear_span_max);   % mm along +X from the surface vertex
...
screen = Screen([screen_offset 0 0], screen_width, screen_height, 512, 512);
