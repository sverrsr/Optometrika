...
example17.m: demonstrates a reflective free-surface gradient detector setup using a sinusoidal mirror profile and generates both ray-hit and continuous heat-map visualisations of the screen
